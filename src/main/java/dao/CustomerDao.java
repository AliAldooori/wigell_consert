...
public class CustomerDao {
    ...
    public Customer getCustomer(Scanner input) {
        System.out.println("enter customer Id you want to get:");
   ...
   /* public void editCustomer(int id, Object[] objectDat) {
    ...
    public void editCustomer( Scanner input) {
        ...
        customer.setDob(Date.valueOf(LocalDate.of(year,mounth,day)));
        ...
        Address address = addressDao.getAddress(input);
